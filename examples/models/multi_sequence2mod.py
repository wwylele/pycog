...
if __name__ == '__main__':
    ...
    rnn  = RNN('work/data/multi_sequence2mod/multi_sequence2mod.pkl', {'dt': 0.5, 'var_rec': 0.01**2,
        'var_in':  np.array([0.003**2])})
    trial_args = {}
    ...
    fig.save(path='.', name='multi_sequence2mod')
    ...
    fig.save(path='.', name='multi_sequence2mod-weight')
